...
import com.example.makeiteasy.adapters.ViewPagerAdapter;

public class ScholarsSlider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scholars_slider);
        ...
        nextbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getitem(0) < 3)
                    ...
                    Intent i = new Intent(ScholarsSlider.this,ScholarsActivity.class);
                    startActivity(i);
